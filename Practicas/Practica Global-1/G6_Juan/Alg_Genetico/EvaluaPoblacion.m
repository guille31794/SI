...
function eval = fEval(espacio, satelites)
    ...
    % Devuelve en eval la suma de todas las distancias de una población
    ...
    d = min(dist);  % Vemos cuál es el representante de cada uno
    eval = sum(d);  % Sumamos las distancias mínimas los sat. a los repr.
